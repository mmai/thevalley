//! This module represents a basic, rule-agnostic 54-cards system.
...
impl FromStr for Suit {
    ...
    fn from_str(s: &str) -> Result<Self, String> {
        match s {
            ...
            "rJ" | "rj" | "red joker" | "Suit::RedJoker" | "Red Joker" => Ok(Suit::RedJoker),
            "bJ" | "bj" | "black joker" | "Suit::BlackJoker" | "Black Joker" => Ok(Suit::BlackJoker),
...
impl Card {
    /// Returns the card id (from 0 to 53).
    pub fn id(self) -> u32 {
        let mut i = 0;
        let Card(mut v) = self;
        while v != 0 {
    ...
    pub fn suit(self) -> Suit {
        let Card(n) = self;
        if n < Suit::Spade as u64 {
            Suit::Heart
        } else if n < Suit::Diamond as u64 {
            Suit::Spade
        } else if n < Suit::Club as u64 {
            Suit::Diamond
        } else if n < Suit::RedJoker as u64 {
            Suit::Club
        } else if n < Suit::BlackJoker as u64 {
            Suit::RedJoker
        } else {
            Suit::BlackJoker
        }
...
impl Deck {
    /// Returns a full, sorted deck of 54 cards.
    pub fn new() -> Self {
        let mut d = Deck {
...
mod tests {
    ...
    fn test_card() {
        ...
        let card = Card::from_id(52);
        assert!(Card::new(Suit::RedJoker, Rank::Rank1) == card);
    }
    ...
    fn test_hand() {
        ...
        let cards: Vec<Card> = vec![
            ...
            Card::new(Suit::RedJoker, Rank::Rank1),
        ];
